...
1. **Vulnerability Title (ចំណងជើង):**
   ...
   * *ឧទាហរណ៍ល្អ:* `IDOR in /api/users/{id} exposes private personal profile details`
   * *ឧទាហរណ៍មិនល្អ:* `Bug found on website`
...
* របាយការណ៍ព្រាងនឹងត្រូវបានរក្សាទុកក្នុងទំព័រ **[Saved Drafts](/dashboard/saved-draft)** ដោយសុវត្ថិភាព។
