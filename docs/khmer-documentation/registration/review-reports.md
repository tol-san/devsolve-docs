> 🌐 **Language / ភាសា:** **🇰🇭 ភាសាខ្មែរ** &nbsp;|&nbsp; [**🇬🇧 Read in English**](../../english-documentation/registration/review-reports.md)

# ការ Review & Triage Reports
...
1. **ពិនិត្យ Scope:**
   * តើ Asset ដែលរងផលប៉ះពាល់ស្ថិតក្នុង In-Scope នៃ Program ដែរឬទេ? ប្រសិនបើខុស សូមបិទជា _Out of Scope_។
