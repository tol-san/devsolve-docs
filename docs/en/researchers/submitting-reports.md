<div align="right" style="margin-bottom: 20px;">
  <a href="../../km/researchers/submitting-reports.md" style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; background: #0284c7; color: #ffffff !important; border-radius: 20px; text-decoration: none; font-size: 13px; font-weight: 600; box-shadow: 0 2px 4px rgba(2, 132, 199, 0.2);">
    🌐 អានជាភាសាខ្មែរ (🇰🇭) ➔
  </a>
</div>
...
1. **Vulnerability Title:**
   ...
   * *Good:* `Account Takeover via Host Header Injection in password reset endpoint`
   * *Poor:* `Critical Bug Found`
