...
Select the bookmark action on supported content. Open **Dashboard → Bookmarks** to search, filter by content type, open an item, or remove the bookmark. A bookmark is private and does not change publication or review state.
