...
<a href="/km/researchers/" class="button secondary">ខ្មែរ</a>
...
```mermaid
flowchart LR
    A[Choose a Program] --> B[Read Scope and Rules]
    B --> C[Obtain Researcher Access]
    C --> D[Submit private Report]
    D --> E[Triage and collaboration]
    E --> F[Accepted or rejected]
    F --> G[Resolution or retest]
```
