...
The `/en` and `/km` paths are routes on the published GitBook site. In this GitHub repository, English—the default space—is stored in `docs/english-documentation`, while Khmer is stored directly in `docs`.
